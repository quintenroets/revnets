...
class Experiment:
    ...
    @classmethod
    def show_plot(
        cls, name: str, merger, num_results: int, names: Sequence[str]
    ) -> None:
    ...
    @classmethod
    def show_results(cls, results, merger, sampling_name: str, color) -> None:
    ...
    @classmethod
    def load_results(cls, name: str | None = None):
