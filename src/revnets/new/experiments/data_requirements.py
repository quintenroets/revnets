...
class Experiment(experiment.Experiment):
    ...
    def load_partial_results(self) -> None:
    ...
    def get_sample_results(self, num_samples: int):
    ...
    def calculate_scale_ratio(self, num_samples: int):
